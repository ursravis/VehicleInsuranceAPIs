...
namespace MetadataService.API
{
    ...
    {
        private readonly IMetadataService _repository;
        private readonly ILocationService locationService;
        private readonly ILogger<CustomersController> _logger;

        public CustomersController(IMetadataService repository, ILocationService locationService, ILogger<CustomersController> logger)
        {
